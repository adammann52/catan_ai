...
class Game:
    ...
    def __init__(self, player_names = ['Adam','Rachel','Julia'],
        ...
        self.sevenBlock = False #used when seven is rolled to enforce moving robber
        self.road_building = False
        self.road_build_count = 0
    ...
    def rollDice(self):
        ...
        self.sevenBlock = self.dieRoll == 7
